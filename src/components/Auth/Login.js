      ...
      {step === 1 ? (
        <React.Fragment>
          ...
          >
            ...
            <p class="text-base font-medium text-gray-800 opacity-70 not-italic">
  For Admin role use <span class="font-semibold text-blue-600">username: admin</span> & 
   <span class="font-semibold text-blue-600">password: adminPass</span>
</p>
          </form>
        </React.Fragment>
      ) : (
